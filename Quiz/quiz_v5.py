...
▐░░░░░░░░░░░▌▐░▌       ▐░▌▐░▌       ▐░▌▐░░░░░░░░░░░▌             ▐░▌  ▐░░░░░░░░░░░▌▐░░░░░░░░░░░▌▐░░░░░░░░░░░▌
 ▀▀▀▀▀▀▀▀▀▀▀  ▀         ▀  ▀         ▀  ▀▀▀▀▀▀▀▀▀▀▀               ▀    ▀▀▀▀▀▀▀▀▀▀▀  ▀▀▀▀▀▀▀▀▀▀▀  ▀▀▀▀▀▀▀▀▀▀▀ 
                                                                                                             """)
print("""\033[1;38;48mWelcome to Jackson's GAME QUIZ
        ...
        def intcheck(question, low, high):
            ...
            while not valid:
                ...
                try:
                    ...
                    print(error)
                    print()
        number = intcheck("\033[1;38;48mHow many questions would you like to be asked out of 10? ", 1, 10)
...
Answer: """]
        ...
        for element in orderlist:
            ...
            if question[element] not in options:
                ...
                print('The correct answer was {}'.format(answer[element].title()))
                rounds += 1
...
loop = False
while loop == False:
    mode = input("To choose a quiz type either 1 or 2; Retro Game Quiz (1) or Modern Game Quiz "
                 "(2): ").strip()
    if mode == "1":
        retro_quiz()
    elif mode == "2":
